      ...
      <div className="mx-auto container px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-18 items-center justify-between">
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'font-extrabold' : 'font-normal hover:font-extrabold',
                      'rounded-md px-3 py-2 text-md text-offBlack ',
                    )}
                  >
                    {item.name}
                  </a>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button
              type="button"
              className="relative rounded-full bg-beige p-1 text-gray-400 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden"
            >
            ...
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className="relative flex rounded-full bg-beige text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden">
                  <span className="absolute -inset-1.5" />
